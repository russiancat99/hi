...
public class MeteorGuiTheme extends GuiTheme {
    ...
    public final Setting<SettingColor> accentColor = color("accent", "Main color of the GUI.", new SettingColor(57, 255, 20));
    public final Setting<SettingColor> checkboxColor = color("checkbox", "Color of checkbox.", new SettingColor(57, 255, 20));
    ...
    public final ThreeStateColorSetting sliderHandle = new ThreeStateColorSetting(
            sgSlider,
            "slider-handle",
            new SettingColor( 0, 255, 65),
            new SettingColor(30, 255, 90),
            new SettingColor(60, 255, 120)
    );
